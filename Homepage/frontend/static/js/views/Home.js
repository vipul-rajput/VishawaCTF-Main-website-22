...
async getHtml() {
    return `
        ...
        <div class="overlay">
        <div class="inner">
            <h1 class="title" data-text="Cybercell VIIT" style="font-size: 6em;">Cybercell VIIT</h1>
            <h2 style="color:#b00000;">Presents</h2>
            <section id="ctf_logo"></section>


            <a class="a-n2" href="https://www.youtube.com/watch?v=6BozpmSjk-Y&t=513s">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
            ...
            </svg><span>13th-14th March</span></p>
        ...
        </div><div class="container my-5 custom-about">
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
                ...
                <div class="col-lg-5 offset-lg-0.5 p-0 overflow-hidden shadow-lg">
                    <img class="rounded-lg-3" src="/static/images/Screenshot (3).png" alt="" width="720"></img>
                </div>
            </div>
        </div><br></br><br></br><div class="custom-carousel">
            <h1 class="glitch" data-text="Our Previous Events" style="text-align: center;font-size: 4em;font-weight: 700; width: 660px;">Our Previous <span style="color: #b00000;">Events</span> </h1>
